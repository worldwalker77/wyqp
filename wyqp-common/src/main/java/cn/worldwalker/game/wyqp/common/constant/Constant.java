...
public class Constant {
	...
	/**roomId与roomInfo的映射*/
	public final static String roomIdRoomInfoMap = curCompany + "room_id_room_info_map";
	/**roomId与gameType,updateTime的映射*/
	public final static String roomIdGameTypeUpdateTimeMap = curCompany + "room_id_game_type_update_time_map";
	/**playerId与roomId,gameType的映射*/
	public final static String playerIdRoomIdGameTypeMap = curCompany + "player_id_room_id_game_type_map";
	/**offline playerId与roomId,gameType,time的映射关系*/
	public final static String offlinePlayerIdRoomIdGameTypeTimeMap = curCompany + "offline_player_id_romm_id_game_type_time_map";
	
	
	/**ip与此ip上连接数的映射关系*/
	public final static String ipConnectCountMap = curCompany + "ip_connect_count_map";
	/**房卡操作失败数据list*/
	public final static String roomCardOperationFailList = curCompany + "room_card_operation_fail_list";
	
	/**请求和返回信息日志打印开关*/
	public final static String logInfoFuse = curCompany + "log_info_fuse";
	/**登录切换开关*/
