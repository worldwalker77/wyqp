...
public enum CommonMsgTypeEnum {
	...
	private CommonMsgTypeEnum(int msgType, String desc){
		this.msgType = msgType;
		this.desc = desc;
	}
	
	public static CommonMsgTypeEnum getMsgTypeEnumByType(int msgType){
		for(CommonMsgTypeEnum msgTypeEnum : CommonMsgTypeEnum.values()){
